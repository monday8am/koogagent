...
private val gemmaModel = LLModel(
...
private class SimpleGemmaAIExecutor(llmClient: LLMClient) : SingleLLMPromptExecutor(llmClient)
...
private class GemmaLLMClient(
    ...
    override suspend fun execute(
        ...
        return prompt.messages.mapNotNull {
