...
/**
 * MediaPipe tool declarations for location and weather functionality. These match the tools defined
 * in the Koog agent module but use MediaPipe's API format.
 */
object MediaPipeTools {
    /**
     * Creates a GetLocation tool declaration. This tool returns the user's current location
    ...
    fun createGetLocationTool(): Tool {
        val getLocationFunction =
            FunctionDeclaration.newBuilder()
                ...
                .setDescription(
                    "Get the user's current location as latitude and longitude coordinates."
                )
                .setParameters(
                    Schema.newBuilder()
                        .setType(Type.OBJECT)
        ...
        return Tool.newBuilder().addFunctionDeclarations(getLocationFunction).build()
    }

    /**
     * Creates a GetWeatherFromLocation tool declaration. This tool returns weather conditions for a
     * given location.
     */
    fun createGetWeatherTool(): Tool {
        ...
        return Tool.newBuilder().addFunctionDeclarations(getWeatherFunction).build()
    }
