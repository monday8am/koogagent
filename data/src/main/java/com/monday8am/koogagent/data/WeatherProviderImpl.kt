...
/**
 * Weather provider using Open-Meteo API (https://open-meteo.com/). No API key required, free for
 * non-commercial use.
 */
class WeatherProviderImpl(
    ...
    /**
     * Maps WMO Weather interpretation codes to WeatherCondition enum. See:
